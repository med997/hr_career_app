...
class _ApplyNowPageState extends State<ApplyNowPage> {
  ...
  void initState() {
    super.initState();
      ...
      context.read<ProfileCubit>().getUserByUuid(context.read<LoginCubit>().authenticatedUser!.userAuth!.id);
              ...
              DynamicModel('pdfName', FormType.subDynForm,
                  ...
                  subFormHeader: Flex(
                      ...
                      children: [
                        ...
                        Document(
                            size: '1.2 MB', fileName: 'ahmedAfeefResume.pdf'),
                        MaterialButton(
                        ...
                        builder: (context, gnState) {
                          if (gnState is GeneralFetchedState) {
                            ...
                            context
                                ...
                                .addSubFormMenuItems('education',
                                    'qualifications', qualificationsItems);
