    ...
    return BlocBuilder<ProfileCubit, ProfileState>(
      builder: (context, state) {
        List<DynamicModel> profileInf () {
         return [
            DynamicModel('fullName', FormType.text, value: '',disabled: !state.isDisabled, validators: [
              DynamicFormValidator(ValidatorType.notEmpty, 'isRequired')
            ]),
            DynamicModel('fullNameAr', FormType.text,disabled: !state.isDisabled,
                value: '',
                validators: [
                  DynamicFormValidator(ValidatorType.notEmpty, 'isRequired')
                ]),
            DynamicModel('currentJob', FormType.text,disabled: !state.isDisabled,
                value: '',
                validators: [
                  DynamicFormValidator(ValidatorType.notEmpty, 'isRequired')
                ]),
            DynamicModel('date', FormType.text, value: '',disabled: !state.isDisabled,
                validators: [
              DynamicFormValidator(ValidatorType.notEmpty, 'isRequired')
            ]),
            DynamicModel('nationality', FormType.dropdown,disabled: !state.isDisabled,
                value: '',
            ...
            DynamicModel('status', FormType.dropdown,disabled: !state.isDisabled,
                value: '',
                // disabled: !state.isDisabled,
                items: [
            ...
            DynamicModel('phone', FormType.phone,disabled: !state.isDisabled,
                value: '',
                // disabled: !state.isDisabled,
                validators: [
                  DynamicFormValidator(ValidatorType.notEmpty, 'isRequired')
                ]),
            DynamicModel('secondaryPhone', FormType.phone,disabled: !state.isDisabled,
                value: '',
                // disabled: !state.isDisabled,
                validators: [
                  DynamicFormValidator(ValidatorType.notEmpty, 'isRequired')
                ]),
            DynamicModel('email', FormType.email,disabled: !state.isDisabled,
                value: '',
                // disabled: !state.isDisabled,
                validators: [
                  DynamicFormValidator(ValidatorType.notEmpty, 'isRequired')
                ]),
            DynamicModel('address', FormType.text,disabled: !state.isDisabled,
                value: '',
                // disabled: !state.isDisabled,
                validators: [
                  DynamicFormValidator(ValidatorType.notEmpty, 'isRequired')
                ]),
            DynamicModel('gender', FormType.dropdown,disabled: !state.isDisabled,
                value: '',
                // disabled: !state.isDisabled,
                items: [
        ...
        List<DynamicModel> profileExp () {
         return [
            DynamicModel('from', FormType.text,disabled: !state.isDisabled,
                value: '',
                icons: !state.isDisabled ? Icon(
            ...
            DynamicModel('to', FormType.text,disabled: !state.isDisabled,
                value: '',
                icons: !state.isDisabled ? Icon(
                  Icons.date_range_outlined,
                  color: Colors.transparent.withOpacity(0.2),
            ...
            DynamicModel('where', FormType.text,disabled: !state.isDisabled,
                value: '',
                icons: !state.isDisabled ? Icon(
            ...
            DynamicModel('jobTitle', FormType.text,disabled: !state.isDisabled,
                value: '',
                icons: !state.isDisabled ? Icon(
        ...
        List<DynamicModel> profileEdc () {
          return [
            ...
            DynamicModel('to', FormType.text,
                value: '',disabled: !state.isDisabled,
                icons: !state.isDisabled ? Icon(
                  Icons.date_range_outlined,
                  color: Colors.transparent.withOpacity(0.2),
                ) : Icon(
        ...
        List<DynamicModel> profileUpl ()
        {
          return [
            DynamicModel('Title', FormType.text,
                ...
                controller: TextEditingController(text: state is FileUploadSuccess ? state.fileName : 'Upload Files',),
                disabled: true,
                value: '',
                validators: [
                  DynamicFormValidator(ValidatorType.notEmpty, 'isRequired')
        ...
        return ListView(
            ...
            children: [
              ...
              DynamicFormWidget(dynamicFormsList: profileInf(), formKey: mainInfoFormKey, useResponsiveUi: true),
              SubTitle(
                title: 'Experience',
              ...
              experienceWidget(
                  ...
                  locationText: 'Riyadh Bank -KSA,Jeddah',
                  infoText: ' Senior Android Developer'),
              DynamicFormWidget(dynamicFormsList: profileExp(), formKey: expFormKey, useResponsiveUi: true),
              Flex(
                direction: Axis.horizontal,
              ...
              educationWidget(
                  ...
                  locationText: 'King Fahd University-KSA,Jeddah',
                  infoText: 'Information Technology'),
              DynamicFormWidget(dynamicFormsList: profileEdc(), formKey: edcFormKey, useResponsiveUi: true),
              SubTitle(
                title: 'Resume',
                titleType: SubTitleType.textOnly,
              ),
              Wrap(
                  ...
                  children: [
                    DynamicFormWidget(dynamicFormsList: profileUpl(), formKey: uplFormKey, useResponsiveUi: true),
                    Container(
                      width: 65,
                      height: 45,
                      decoration: BoxDecoration(
                            ...
                            child: IconButton(
                              ...
                              onPressed: () async {
                                ...
                                if (result != null && result.files.isNotEmpty) {
                                  ...
                                  context.read<ProfileCubit>().uploadFile(
                                      fileName);
                                }
                              },
                              icon: const Icon(
