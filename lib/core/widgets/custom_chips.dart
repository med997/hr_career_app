...
class CustomChips extends StatelessWidget {
  ...
  Color? txtColor;
  double? txtSize;
  CustomChips({required this.chipsTitles, this.bgColor, this.txtColor, this.txtSize});

  @override
  Widget build(BuildContext context) {
    return Wrap(
spacing: 4, alignment: WrapAlignment.start,
      children: [
        ...
        ...chipsTitles.map(
          (title) {
            return Container(
              ...
              child: Text(
                title,
                style: TextStyle(color: txtColor?? Colors.white, fontSize: txtSize ?? 12),
              ),
            );
          },
        )
